...
public class Product {
    ...
    public Product(Long id, Long categoryId, String name, String author, String subtitle, String press, Date publishDate, String mainImg, String subImg, String thumbnail, String detail, BigDecimal pricing, BigDecimal price, Long stock, Long grade, Long commentNum, Long sale, Integer status, Date createTime, Date updateTime) {
        this.id = id;
